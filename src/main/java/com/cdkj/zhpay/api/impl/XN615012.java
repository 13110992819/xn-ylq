...
import com.cdkj.zhpay.dto.req.XN615012Req;
 ...
 * @history:
 */
public class XN615012 extends AProcessor {
    private IJewelAO jewelAO = SpringContextHolder.getBean(IJewelAO.class);

    private XN615012Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtils.json2Bean(inputparams, XN615012Req.class);
