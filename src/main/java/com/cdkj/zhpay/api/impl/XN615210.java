...
import com.cdkj.zhpay.dto.req.XN615210Req;
 ...
 * @history:
 */
public class XN615210 extends AProcessor {
    private IStockAO stockAO = SpringContextHolder.getBean(IStockAO.class);

    private XN615210Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN615210Req.class);
