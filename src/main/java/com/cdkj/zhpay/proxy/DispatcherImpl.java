package com.cdkj.zhpay.proxy;

import com.cdkj.zhpay.api.IProcessor;
...
public class DispatcherImpl implements IDispatcher {
    ...
    public String doDispatcher(String transcode, String inputParams) {
        ...
        try {
            // 加载配置文件,proxy实例化
            String classname = "com.cdkj.zhpay.api.impl.XNOther";
             ...
             * "com.cdkj.zhpay.api.impl.XN" + transcode; } }
             */
            classname = "com.cdkj.zhpay.api.impl.XN" + transcode;
