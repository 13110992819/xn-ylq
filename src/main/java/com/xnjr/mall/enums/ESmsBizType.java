...
public enum ESmsBizType {
    REGISTER("1", "平台账户-注册"), FINDLOGINPWD("2", "平台账户-找回登陆密码"), RESETLOGINPWD(
            "3", "平台账户-重置登陆密码"), SETTRADEPWD("4", "平台账户-设置支付密码"), FINDTRADEPWD(
            "5", "平台账户-找回支付密码"), RESETTRADEPWD("6", "平台账户-重置支付密码"), CHANGEMOBILE(
    ...
    , HongLan("30", "平台账户-红冲蓝补"), Hong("31", "平台账户-红冲"), Lan("32", "平台账户-蓝补"), MOOM_startMJ(
            ...
            "M11", "生意家，操盘手重置支付密码"), MOOM_CPS_FindTP("M12", "生意家，操盘手找回支付密码"), MOOM_CPS_ChangePH(
